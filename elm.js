...
var $author$project$Main$Model = F2(
	function (hover, shas) {
		return {E: hover, Q: shas};
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A2($author$project$Main$Model, false, _List_Nil),
...
var $author$project$Main$GotShas = function (a) {
	return {$: 4, a: a};
};
														...
														return function (b14) {
															return function (b15) {
																return function (b16) {
																													...
																													A3(
																														...
																														A3(
																															...
																															A3(
																																...
																																1,
																																b2,
																																A3($TSFoster$elm_sha1$SHA1$calculateDigestDeltas, 0, b1, initial))))))))))))))));
																	...
																	var d = _v1.o;
																	var e = _v1.p;
																	return A5($TSFoster$elm_sha1$SHA1$Tuple5, initial.l + a, initial.m + b, initial.n + c, initial.o + d, initial.p + e);
																};
															};
														};
													};
...
var $TSFoster$elm_sha1$SHA1$stateToDigest = function (_v0) {
	...
	var d = _v0.o;
	var e = _v0.p;
	return {l: a >>> 0, m: b >>> 0, n: c >>> 0, o: d >>> 0, p: e >>> 0};
};
		...
		switch (msg.$) {
			...
			case 3:
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$core$Task$perform,
						$author$project$Main$GotShas,
						$elm$core$Task$sequence(
							A2(
								$elm$core$List$map,
								A2(
									$elm$core$Basics$composeR,
									$elm$file$File$toBytes,
									$elm$core$Task$map(
										A2($elm$core$Basics$composeR, $TSFoster$elm_sha1$SHA1$fromBytes, $TSFoster$elm_sha1$SHA1$toHex))),
...
var $author$project$Main$DragEnter = {$: 1};
var $author$project$Main$DragLeave = {$: 2};
var $author$project$Main$Pick = {$: 0};
...
var $author$project$Main$dropDecoder = A2(
	$elm$json$Json$Decode$at,
	_List_fromArray(
		['dataTransfer', 'files']),
	A2($elm$json$Json$Decode$oneOrMore, $author$project$Main$GotFiles, $elm$file$File$decoder));
...
var $author$project$Main$hijackOn = F2(
	function (event, decoder) {
		return A2(
...
var $author$project$Main$viewPreview = function (url) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				'border',
				model.E ? '6px dashed purple' : '6px dashed #ccc'),
				...
				A2(
				$author$project$Main$hijackOn,
				'dragenter',
				$elm$json$Json$Decode$succeed($author$project$Main$DragEnter)),
				A2(
				$author$project$Main$hijackOn,
				'dragover',
				$elm$json$Json$Decode$succeed($author$project$Main$DragEnter)),
				...
				$author$project$Main$hijackOn,
				'dragleave',
				$elm$json$Json$Decode$succeed($author$project$Main$DragLeave)),
				A2($author$project$Main$hijackOn, 'drop', $author$project$Main$dropDecoder)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$Pick)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Upload Files to calculate their SHAs')
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				A2($elm$core$List$map, $author$project$Main$viewPreview, model.Q))
			]));
};
